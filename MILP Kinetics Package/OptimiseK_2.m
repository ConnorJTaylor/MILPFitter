...
try %try operator necessary in case parpool is already open.
    ...
    parpool(core_info); %prepare for parfor loop. Can be replaced with how many cores your computer has.
catch
end
...
for CombNo = 1:1
    ...
    parfor I = 1:100 %for every model within the block.
        ...
        ub = lb+1; %upper bound. This must be changed for faster reactions.
